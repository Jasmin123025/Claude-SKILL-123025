Hi please create app.py (combine all codes), SKILL.md, agents.yaml based on the technical specification and previous SKILL.md to be deployed on Hugging face space using streamlit, agents.yaml, SKILL.md Ending with 20 follow up questions. <scratchpad>
